...
<link rel="stylesheet" href="{{url('customer-dashboard/css/bootstrap.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{url('customer-dashboard/css/animate.css')}}">
...
<!--  <script src="{{url('customer-dashboard/js/jquery-3.1.0.js')}}"></script> -->
<script src="{{url('customer-dashboard/js/popper.min.js')}}"></script>
<script src="{{url('customer-dashboard/js/bootstrap.min.js')}}"></script> 

<script src="{{url('customer-dashboard/js/animation.js')}}"></script>
<script type="text/javascript" src="{{url('customer-dashboard/js/smooth-scrollbar.js')}}"></script>
<script type="text/javascript" src="{{url('customer-dashboard/js/custom.js')}}"></script>
