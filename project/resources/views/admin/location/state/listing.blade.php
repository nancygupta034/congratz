                ...
                <div class="col-md-12">
                    <div class="dashboard_heading">
                        ...
                        <div class="dashboard_title_btn user_dashboard_title_btn">
                            <a href="{{ route('admin.stateAdd') }}" type="button" class="btn add_new_btn">Add New</a>
            ...
            <div class="row">
				<div class="col-md-12 d-flex justify-content-between button_tab_wrapper">
                    <ul class="button_tab_outer">
                        ...
                        <li><a class="btn tab_btn active" href="{{route('admin.stateListing')}}">States</a></li>
                        <li><a class="btn tab_btn" href="{{route('admin.cityListing')}}">Cities</a></li>
                    </ul>
                ...
                <!--div class="col-md-12">
                    <div class="dashboard_heading">
                        <div class="dashboard_title">
                            ...
                            <a class="active"  href="{{route('admin.stateListing')}}">States</a>
                            <a href="{{route('admin.cityListing')}}">Cities</a>
                        </div>
                    ...
                    <thead>
                        <tr>
                            ...
                            <tbody>
                             ...
                             @if(@sizeof($states)) @foreach($states as $k => $listingStates)

                                <tr id="row_{{ $listingStates->id }}">
                                     <td>{{$k + 1}}</td>
                                    <td>{{ $listingStates->name }}</td>

                                    <td>{{ $listingStates->country->name }}</td>

                                    <td>

                                        <a href="{{ route('admin.stateEdit', $listingStates->id) }}">

                                            <button class="btn pink_outline edit_btn"><i class="fa fa-fw fa-edit"></i>Edit</button>

                                        </a>

                                        <button id="{{ $listingStates->id }}" class="btn pink_outline removeState"><i class="fa fa-fw fa-times-circle"></i>Remove</button>
...
$(document).ready(function(){
    ...
    $('.removeState').click(function(){
        ...
        var url = "{{ route('admin.stateDelete') }}";
