...
@section("content")
    ...
    <div class="main_content dashboard_content">
            ...
            <form class="row"  method="POST" action="{{ route('admin.serviceAdd') }}" 
                    ...
                    @csrf
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" name="name" class="form-control" id="name" placeholder="Enter Service Name" required>
