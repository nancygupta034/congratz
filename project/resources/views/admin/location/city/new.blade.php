...
@section("content")
    ...
    <div class="main_content dashboard_content">
            ...
            <form class="row"  method="POST" action="{{ route('admin.cityAdd') }}" 
                        ...
                        <div class="box-body">
                           ...
                           <div class="form-group">
                                ...
                                <select class="form-control" name="country" id="country" required>
                                  <?php $Country = \App\Models\Country::orderBy('name','ASC')->get(); ?>
                                     @if(@sizeof($Country))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" name="name" class="form-control" id="name" placeholder="Enter City Name" required>
