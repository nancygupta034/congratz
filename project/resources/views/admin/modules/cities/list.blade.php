        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{_lang('City List')}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              ...
              <div class="card-tools">
                <a href="{{route('admin.city.create')}}" class="btn btn-success btn-sm">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                 <div class="col-md-12">
                    <form id="tableFilter" data-action="{{route('admin.city.list')}}">
                      @csrf
                      <table class="table">
                        <thead>
                          <tr>
...
function getCategory($url="{{route('admin.city.ajax')}}") {
