...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{_lang('Contact Us Page Settings')}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{_lang('Contact Us Page')}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                              ...
                              <div class="mb-3">
                               <div class="card card-primary">
                                        ...
                                        <form role="form" id="cmsForm" action="{{route('admin.website.settings.store.lang',$lang)}}" method="post" enctype="multipart/form-data">
                                          <div class="card-body">
                                            @csrf
                                            <input type="hidden" name="type" value="contact-us-page">
                                            ...
                                            <div class="col-md-12">
                                                 <div class="form-group">
                                                           ...
                                                           <input type="text" class="form-control" name="contact_us_title" value="<?= $data['contact_us_title'] ?>">
                                                 </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                 <div class="form-group">
                                                           <label for="category-label">{{_lang('Tagline')}}</label>
                                                           <textarea class="form-control" name="contact_us_tagline"><?= $data['contact_us_tagline'] ?></textarea>
                                                 </div>
                                            </div>
