...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{_lang('ARABRIC LANGUAGE')}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{_lang('Dashboard')}}</a></li>
              <li class="breadcrumb-item active">{{_lang('Language List')}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          ...
          <div class="card card-outline card-info">
            <div class="card-header">
              <h3 class="card-title">
                {{_lang('Language Listing')}}
              </h3>
              <!-- tools box -->
               <div class="card-tools">
                <a href="{{route('admin.website.languages.create')}}" class="btn btn-success btn-sm">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                 <div class="col-md-12">
                    <form id="tableFilmter" data-action="">
                      @csrf
                      <table class="table">
                        <thead>
                          <tr>
...
function getCategory() {
  var $loader = $("body").find('.loader');
   $.ajax({
                url : "{{route('admin.website.languages')}}",
                type: 'POST',  
                dataTYPE:'JSON',
