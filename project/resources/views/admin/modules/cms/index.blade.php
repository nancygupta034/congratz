        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">{{_lang('CMS List')}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            <div class="card-header">
              <h3 class="card-title">
                {{_lang('CMS Page Listing')}}
                 
              </h3>
              <!-- tools box -->
              <div class="card-tools">
                <a href="{{route('admin.cms.add')}}" class="btn btn-success btn-sm">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                 <div class="col-md-12">
                    <form id="tableFilter" data-action="{{route('admin.cms')}}">
                      @csrf
                      <table class="table">
                        <thead>
                          <tr>
                                      ...
                                      <th>{{_lang('Page Title')}}</th>
                                      <th colspan="2">{{_lang('Actions')}}</th>
                          </tr>
                        </thead>
...
function getCategory($url="{{route('admin.cms.ajax')}}") {
