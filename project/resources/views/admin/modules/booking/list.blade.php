...
@section('content')
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{_lang('Booking')}} ({{_lang($type)}})</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">{{_lang('Dashboard')}}</a></li>
              <li class="breadcrumb-item active">{{_lang('Booking List')}}</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            ...
            <div class="card-body pad">
              <div class="mb-3">
                 <div class="col-md-12">
                    <form id="tableFilter" data-action="{{route('admin.booking.ajax',$type)}}">
                       <div class="row">
                         <div class="col-md-3">
                            <a href="{{route('admin.booking.list','pending')}}" class="btn-primary">{{_lang('Pending')}}</a>
                         </div>
                         <div class="col-md-3">
                         <a href="{{route('admin.booking.list','approved')}}" class="btn-primary">{{_lang('Approved')}}</a>
                         </div>
                       </div>
...
$("body").on('click','.formFilters',function(){
   var $this = $(this);
...
function getCategory($url="{{route('admin.booking.ajax',$type)}}") {
