...
@section('content')
       ...
       <div class="main-heading mb-5">
        ...
        <div class="row">
              ...
              <div class="card_head d-f j-c-s-b a-i-c">
               ...
               <div class="tr_user_info">
                 ...
                 <figcaption class="tr_pro_info">
                  ...
                  <a href="{{route('artist.myvideos')}}" class="main-btn2">Back</a>
                  </div>
                 </figcaption>
               </div>
            ...
            <div class="personalized_reviews">
              ...
              <div class="tr_rating">
                 ...
                 <p class="review-message d-inline">{{$review->reviews}}</p> 
                      <a href="javascript:void(0);" class="main-btn d-inline fs-6 "  data-toggle="modal" data-target="#exampleModal-{{$review->id}}">Reply</a>
          ...
          <div class="modal fade" id="exampleModal-{{$review->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                 <form id="bookingUploadVideoForm" data-action="{{route('artist.myvideos.review',[$book->id,$review->id])}}">
  ...
  @if($book->profile_showable == 0)

          <div class="setting-btns d-f align-items-baseline">
             <h3>Set Video to profile</h3>
                <label class="switch ml-4" for="profile_video">
                  <input type="checkbox" class="changeProfileVideoSettings" data-type="profile_video" value="1" data-action="{{route('artist.myvideoProfileSetting',$book->id)}}" name="profile_video" id="profile_video" data-value="{{$book->profile_video == 1 ? 0 : 1}}" {{$book->profile_video == 1 ? 'checked' : ''}}>
                  <span class="slider round"></span>
                </label>
          </div>
             <div class="setting-btns d-f align-items-baseline">
             <h3>Set Review to profile</h3>
                <label class="switch ml-4" for="profile_review">
                  <input type="checkbox" class="changeProfileVideoSettings" data-type="profile_review" value="1" data-action="{{route('artist.myvideoProfileSetting',$book->id)}}" name="profile_review" id="profile_review" data-value="{{$book->profile_review == 1 ? 0 : 1}}" {{$book->profile_review == 1 ? 'checked' : ''}}>
                  <span class="slider round"></span>
                </label>
          </div>
...
$("body").on('change','.changeProfileVideoSettings',function(e){
      e.preventDefault();
      getBookingItems($(this));
});


function getBookingItems($this) {
