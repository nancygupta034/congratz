...
<div class="content-block">
             ...
             <div class="card-block mb-5">
                 ...
                 <div class="form-group">
                   <div class="switch-holder">
                    <div class="switch-label">
                        <i class="fas <?= Auth::user()->availability == 1 ? 'fa-eye' : 'eye-slash'?> "></i><span>Set profile available</span>
                    </div>
                    <div class="switch-toggle" data-children-count="1">
           ...
           <?php $Switch = Session::has('locale') && Session::get('locale') == 'AR' ? 'Switch to English' : 'Switch to Arabic'; ?>
            ...
            <div class="switch-toggle">
                ...
                <div class="profile-setting_card mb-4">
                  <form id="changePassword" data-action="{{route('artist.changePassword')}}">
                    @csrf
                ...
                <div class="form-group">
                   ...
                   <div class="input_wrap">
                    <span class="input-left-icon"><i class="fas fa-lock"></i></span>
                    <input type="password" name="password_confirmation" id="confirm_password" class="form-control" placeholder="New Password">
                    <div class="input-right-icon">
                      <a href=""> <i class="fas fa-eye"></i></a>
                    </div>
                  </div>
             ...
             <!--  <div class="profile-setting_card mb-4">
                <div class="card-inn-heading mb-4"><h3>Switch Language</h3></div>
                 <div class="form-group">
                   <label class="inline-label mb-2">Choose Languahe</label>
